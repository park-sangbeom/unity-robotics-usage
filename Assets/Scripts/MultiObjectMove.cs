...
public class MultiObjectMove : MonoBehaviour
{
    [Header("ROS Setup")]
    ROSConnection ros; 
    ...
    void Start()
    {
        ...
        // Debug.Log("Table"+table_num+": Initialization Server ON");
    }
    ...
    void Update()
    {
        // Time.timeScale = 5F; // If it is too high, It makes a bug in the collide part
